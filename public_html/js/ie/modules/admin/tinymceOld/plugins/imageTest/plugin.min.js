tinymce.PluginManager.add('imageTest', function (a) {
  function b(a, b) {
    function c(a, c) {
  ...
  function d(b) {
    return function () {
	  ...
	  console.log(a.windowManager.windows[0]);
    }
  }
  function e(d) {
    function e() {
    ...
    function f() {
      ...
      a.undoManager.transact(function () {
        ...
        if ('' === s.title && (s.title = null), m ? t.setAttribs(m, s)  : (s.id = '__mcenew', a.focus(), a.selection.setContent(t.createHTML('img', s)), m = t.get('__mcenew'), t.setAttrib(m, 'id', null)), a.editorUpload.uploadImagesAuto(), s.caption === !1 && t.is(m.parentNode, 'figure.imageTest') && (c = m.parentNode, t.insertAfter(m, c), t.remove(c)), s.caption !== !0) b(m);
         else if (!t.is(m.parentNode, 'figure.imageTest')) {
          d = m,
          m = m.cloneNode(!0),
          c = t.create('figure', {
            'class': 'imageTest'
    ...
    n = t.getParent(m, 'figure.imageTest'),
    ...
    a.settings.image_load !== !1 && v.push({
      name: 'loadImage',
      type: 'button',
      text: 'Load image',
      onclick: function test() {v[0].value = 'test';console.log(v);a.windowManager.open({
