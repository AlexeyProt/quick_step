...
// Наследуюет класс Feedback
OpenFeedback.prototype = Object.create(Feedback.prototype);
OpenFeedback.prototype.constructor = OpenFeedback;

/* Внутренние методы */

// Активирует анимации кнопок формы
OpenFeedback.prototype._activFormButons = function () {
...
OpenFeedback.prototype._activOpenButons = function () {
...
OpenFeedback.prototype._activCloseButons = function () {
...
OpenFeedback.prototype._animError = function () {
	var self = this,
		initialColorsFG = [
...
OpenFeedback.prototype._animSucces = function () {
	var self = this,
		finalColorsFG = [
...
// Устанавливает события кликов на кнопки с аттрибутом data-open="feedback" для открытия формы
OpenFeedback.prototype.open = function () {
	var self = this,
		openButtons = document.querySelectorAll('[data-open="feedback"]');
	for (var i = 0; i < openButtons.length; i++) {
...
OpenFeedback.prototype.close = function () {
	var self = this;
...
OpenFeedback.prototype.activAnimElems = function () {
