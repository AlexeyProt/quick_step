"use strict";
/* Редактор услуги */
class ServiceEditor extends BaseForm {
	constructor(args) {
		super(args);
	...
	async _saveHandler() {
		this.url = "/admin/service/update"; // url для ajax запроса
		// Если данные отправляеются со страницы с url '/admin/service/create'
		if ( document.location.pathname === '/admin/service/create' ) {
			this.url = "/admin/service/store";
		}
