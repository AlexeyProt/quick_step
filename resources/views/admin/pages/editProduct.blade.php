...
@section('content')
<script src="{{ asset('js/views/admin/editProductView.js') }}" defer></script>
...
<div class="content">
	...
	<form name="productEditor">
		...
		<div class="imageContainer" style="min-width: 500px; cursor:pointer;">
			...
			<p><span data-name="price_history[price]" data-module="quantityVidjet" contenteditable="true">{{ $product->price->price_history->price or $categoryPrice }}</span> руб.</p>
			<div class="miniCont">
